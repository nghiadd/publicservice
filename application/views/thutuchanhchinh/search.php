		<div id="primary">
			...
			<div id="content">	
			<h3>Tìm thấy <span><?php echo $total; ?></span> thủ tục</h3>
				<table id="list_service">
					...
					<?php $i = $this->uri->segment(4); if($i == NULL) $i = 0; ?>
					...
					<tr>
						...
						<td class="list_service_col3" ><?php echo $row7[$item['service_id']]['agency_name']; ?></td>
						<td class="list_service_col4" ><?php echo $row6[$item['service_id']]['field_name']; ?></td>
					</tr>
					<?php endforeach; ?>
				</table>
				<!-- End #table_bottom -->
